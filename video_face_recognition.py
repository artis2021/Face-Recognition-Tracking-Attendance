...
Arti Sahu_image = face_recognition.load_image_file('images/samples/abhi.jpg')
Arti Sahu_face_encodings = face_recognition.face_encodings(Arti Sahu_image)[0]

#save the encodings and the corresponding labels in seperate arrays in the same order
known_face_encodings = [modi_face_encodings, trump_face_encodings, Arti Sahu_face_encodings]
known_face_names = ["Narendra Modi", "Donald Trump", "Arti Sahu"]
